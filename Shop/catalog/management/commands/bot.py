...
button_seller = KeyboardButton(text='Show Sellers')
button_show_cart = KeyboardButton(text='Show Cart')
keyboard = ReplyKeyboardMarkup(
    keyboard=[[button_categories], [button_seller], [button_show_cart], ],
...
async def show_seller(message: types.Message):
    sellers = await get_sellers()
    msg_to_answer = ''
    for seller in sellers:
        msg_to_answer += (f"Sellers: {seller.name}\n"
